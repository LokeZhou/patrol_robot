...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_18d.pack(_x.itow.data, _x.fix.data, _x.latitude, _x.longitude, _x.hEll, _x.hMsl, _x.vel.x, _x.vel.y, _x.vel.z, _x.hAcc, _x.vAcc, _x.sAcc, _x.pDop, _x.hDop, _x.vDop, _x.numSat, _x.heading, _x.headingAcc))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.itow.data, _x.fix.data, _x.latitude, _x.longitude, _x.hEll, _x.hMsl, _x.vel.x, _x.vel.y, _x.vel.z, _x.hAcc, _x.vAcc, _x.sAcc, _x.pDop, _x.hDop, _x.vDop, _x.numSat, _x.heading, _x.headingAcc,) = _struct_18d.unpack(str[start:end])
      return self
