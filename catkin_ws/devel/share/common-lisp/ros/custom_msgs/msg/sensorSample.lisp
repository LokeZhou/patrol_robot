...
(cl:defclass <sensorSample> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (internal
    :reader internal
    :initarg :internal
    :type custom_msgs-msg:Internal
    :initform (cl:make-instance 'custom_msgs-msg:Internal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <sensorSample>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sensorSample)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<sensorSample> is deprecated: use custom_msgs-msg:sensorSample instead.")))
...
(cl:defmethod internal-val ((m <sensorSample>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msgs-msg:internal-val is deprecated.  Use custom_msgs-msg:internal instead.")
  (internal m))
