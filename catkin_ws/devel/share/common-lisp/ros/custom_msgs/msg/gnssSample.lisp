...
(cl:defclass <gnssSample> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass gnssSample (<gnssSample>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <gnssSample>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'gnssSample)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<gnssSample> is deprecated: use custom_msgs-msg:gnssSample instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <gnssSample>))
...
(cl:defmethod itow-val ((m <gnssSample>))
...
(cl:defmethod fix-val ((m <gnssSample>))
...
(cl:defmethod latitude-val ((m <gnssSample>))
...
(cl:defmethod longitude-val ((m <gnssSample>))
...
(cl:defmethod hEll-val ((m <gnssSample>))
...
(cl:defmethod hMsl-val ((m <gnssSample>))
...
(cl:defmethod vel-val ((m <gnssSample>))
...
(cl:defmethod hAcc-val ((m <gnssSample>))
...
(cl:defmethod vAcc-val ((m <gnssSample>))
...
(cl:defmethod sAcc-val ((m <gnssSample>))
...
(cl:defmethod pDop-val ((m <gnssSample>))
...
(cl:defmethod hDop-val ((m <gnssSample>))
...
(cl:defmethod vDop-val ((m <gnssSample>))
...
(cl:defmethod numSat-val ((m <gnssSample>))
...
(cl:defmethod heading-val ((m <gnssSample>))
...
(cl:defmethod headingAcc-val ((m <gnssSample>))
  ...
  (headingAcc m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <gnssSample>) ostream)
  "Serializes a message object of type '<gnssSample>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <gnssSample>) istream)
  "Deserializes a message object of type '<gnssSample>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<gnssSample>)))
  "Returns string type for a message object of type '<gnssSample>"
  "custom_msgs/gnssSample")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'gnssSample)))
  "Returns string type for a message object of type 'gnssSample"
  "custom_msgs/gnssSample")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<gnssSample>)))
  "Returns md5sum for a message object of type '<gnssSample>"
  "d0573311aa10335e691a2e99fd2b6d50")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'gnssSample)))
  "Returns md5sum for a message object of type 'gnssSample"
  "d0573311aa10335e691a2e99fd2b6d50")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<gnssSample>)))
  "Returns full string definition for message of type '<gnssSample>"
  (cl:format cl:nil "# This is a message to hold data a GNSS unit~%# Supported for MTi Devices with FW 1.4 and above.~%~%Header header~%~%float64 itow~%float64 fix~%~%float64 latitude~%float64 longitude~%float64 hEll~%float64 hMsl~%~%# ENU velocity~%geometry_msgs/Vector3 vel~%~%float64 hAcc~%float64 vAcc~%float64 sAcc~%~%float64 pDop~%float64 hDop~%float64 vDop~%~%float64 numSat~%float64 heading~%float64 headingAcc~%~%~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'gnssSample)))
  "Returns full string definition for message of type 'gnssSample"
  (cl:format cl:nil "# This is a message to hold data a GNSS unit~%# Supported for MTi Devices with FW 1.4 and above.~%~%Header header~%~%float64 itow~%float64 fix~%~%float64 latitude~%float64 longitude~%float64 hEll~%float64 hMsl~%~%# ENU velocity~%geometry_msgs/Vector3 vel~%~%float64 hAcc~%float64 vAcc~%float64 sAcc~%~%float64 pDop~%float64 hDop~%float64 vDop~%~%float64 numSat~%float64 heading~%float64 headingAcc~%~%~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <gnssSample>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <gnssSample>))
