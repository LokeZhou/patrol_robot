...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/exbot/catkin_ws/src/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/exbot/catkin_ws/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/exbot/catkin_ws/install)
...
if(NOT "/home/exbot/catkin_ws/src/openslam_gmapping/include" STREQUAL "")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/exbot/catkin_ws/src/openslam_gmapping/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/exbot/catkin_ws/src/openslam_gmapping/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
