...
if("TRUE" STREQUAL "TRUE")
  set(custom_msgs_SOURCE_PREFIX /home/exbot/catkin_ws/src/xsens_mti_ros_node/src/custom_msgs)
  set(custom_msgs_DEVEL_PREFIX /home/exbot/catkin_ws/devel)
  ...
  set(custom_msgs_INSTALL_PREFIX /home/exbot/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'custom_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'custom_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/exbot/catkin_ws/src/xsens_mti_ros_node/src/custom_msgs/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
set(depends "rospy;roscpp;std_msgs;sensor_msgs;message_generation;message_runtime")
